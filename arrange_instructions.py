...
for iblock in range(nBlocks):  
    ...
    experiment_details_text = 'This session consists of 7 blocks. Each block lasts about 11 minutes. There will be short breaks between each block. Use this time to rest and prepare for the next block. Please press any button to continue for detailed instructions about the experimental procedure.'
    ef.display_text(experiment_details_text, win)
    kb.waitKeys(keyList=['1', '2', '3', '4'], waitRelease=True)

    experimental_instructions = 'During each block, you will hear long sequences of noise-like sounds. Some of these sequences contain repeating chunks, while others do not. Your task is to listen carefully and report whether or not you hear repeating chunks by answering "yes" or "no." If you detect repeating chunks, answer "yes." If you do not detect repeating chunks, answer "no." Try to respond as quickly as possible while maintaining high accuracy.\n' + 'Press any button to continue.'
